//export default Carousel; указать в конце
class Carousel {
 constructor(p) {
 let settings = {...{containerID: '#carousel', slideID: '.slide', interval: 1000, isPlaying: true}, ...p};
 
  //let settings = this._initConfig(params); к вариаетам 1-3
 ...
 //V#2
 //_initConfig(o) {
 //   const d = {containerID: '#carousel', slideID: '.slide', interval: 1000, isPlaying: true};
 //
 //   //const copyObj = Object.assign({}, objectParams);
 //   //const copyObj2 = {...defaultSettings, ...objectParams}; // деструктуризация
 //   //return copyObj2;
 //    return {...d, ...o};
 // }
 ...
 //const PAUSE = `<span id="pause-btn" class="control-pause"><span id="fa-pause-icon" style="opacity: 1;">${this.isPlaying ? this.FA_PAUSE : this.FA_PLAY}</span></span>`;
